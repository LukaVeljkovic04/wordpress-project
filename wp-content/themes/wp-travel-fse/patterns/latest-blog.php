...
<h2 class="wp-block-heading has-text-align-center has-x-large-font-size" style="margin-bottom:0"><?php echo esc_html( "Latest Travel Blog", "wp-travel-fse" ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0","padding":{"top":"var:preset|spacing|40","right":"var:preset|spacing|30","bottom":"0","left":"var:preset|spacing|30"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:0;padding-left:var(--wp--preset--spacing--30)"><!-- wp:post-title {"level":3,"isLink":true,"fontSize":"medium"} /-->
...
<p class="has-small-font-size" style="margin-right:var(--wp--preset--spacing--30)"><strong>On</strong></p>
<!-- /wp:paragraph -->
